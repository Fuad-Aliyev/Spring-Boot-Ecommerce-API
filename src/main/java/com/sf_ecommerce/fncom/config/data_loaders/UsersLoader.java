package com.sf_ecommerce.fncom.config.data_loaders;
...
import com.sf_ecommerce.fncom.services.RoleService;
import com.sf_ecommerce.fncom.services.UserService;
...
public class UsersLoader implements ApplicationListener<ContextRefreshedEvent> {
    ...
    public UsersLoader(RoleService roleService,
    ...
    public void onApplicationEvent(ContextRefreshedEvent event) {
        ...
        createUserIfNotFound("admin", bCryptPasswordEncoder.encode("12345"),
